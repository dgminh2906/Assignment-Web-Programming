    ...
    <div class="container bg-light mt-3" style="margin-top: 100px; margin-bottom: 100px">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="floatingaddress" name="address" value="<?php echo $nameRow['address']?>" placeholder="Địa chỉ"></textarea>
            </div>
            <div class="mb-3">
    ...
    <div class="footer_info" style="padding-left:150px; background-color:#fdfefd;">
        <div class="row">
            <div class="col-md-4 col-sm-6">
                <img src="../images/thanhtoan.jpg" alt="TimeElite" width="100%">
            </div>
            <div class="col-md-4 col-sm-6">
                <img src="../images/connect.jpg" alt="TimeElite" width="100%">
            </div>
            <div class="col-md-4 col-sm-12">
                <img src="../images/dangky.jpg" alt="TimeElite" width="100%">
            </div>
        </div>
    </div>
    <?php   
